...
export type RecoveryCaseSummary = { id: string; status: string; correlation_id: string; amount_minor: number; currency: string; created_at: string };
...
export type ExternalOutcome = { id: string; status: string; verified: boolean; amount_minor: number; currency: string; occurred_at: string };
export type RecoveryAttribution = { execution_mode: string; amount_minor: number; currency: string; occurred_at: string; attribution_source: string };
...
function isRecoveryCaseSummary(value: unknown): value is RecoveryCaseSummary { return hasCoreCase(value) && typeof value.created_at === "string"; }
